...
# DVE full session
# Saved on Mon May 30 00:21:18 2022
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{8 31} {1710 950}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 282} {height 392} {dock_state left} {dock_on_new_line true} {child_hier_colhier 306} {child_hier_coltype 10} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 237} {height 392} {dock_state left} {dock_on_new_line true} {child_data_colvariable 193} {child_data_colvalue 100} {child_data_coltype 40} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
set Console.1 [gui_create_window -type Console -parent ${TopLevel.1} -dock_state bottom -dock_on_new_line true -dock_extent 429]
gui_set_window_pref_key -window ${Console.1} -key dock_width -value_type integer -value 1647
gui_set_window_pref_key -window ${Console.1} -key dock_height -value_type integer -value 429
gui_set_window_pref_key -window ${Console.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1702} {height 428} {dock_state bottom} {dock_on_new_line true}}
...
set _session_group_26 data_memory1
gui_sg_create "$_session_group_26"
set data_memory1 "$_session_group_26"

gui_sg_addsignal -group "$_session_group_26" { riscv8bit_tb.data_memory1.ram_memory riscv8bit_tb.data_memory1.memread riscv8bit_tb.data_memory1.i riscv8bit_tb.data_memory1.read_ram_data riscv8bit_tb.data_memory1.memwrite riscv8bit_tb.data_memory1.address_ram riscv8bit_tb.data_memory1.write_data riscv8bit_tb.data_memory1.rst }
...
set _session_group_27 registerfile1
gui_sg_create "$_session_group_27"
set registerfile1 "$_session_group_27"

gui_sg_addsignal -group "$_session_group_27" { riscv8bit_tb.uut.id_to_wb1.id_and_ex1.id1.registerfile1.register_memory riscv8bit_tb.uut.id_to_wb1.id_and_ex1.id1.registerfile1.rd riscv8bit_tb.uut.id_to_wb1.id_and_ex1.id1.registerfile1.rs riscv8bit_tb.uut.id_to_wb1.id_and_ex1.id1.registerfile1.write_address riscv8bit_tb.uut.id_to_wb1.id_and_ex1.id1.registerfile1.clk riscv8bit_tb.uut.id_to_wb1.id_and_ex1.id1.registerfile1.regwrite riscv8bit_tb.uut.id_to_wb1.id_and_ex1.id1.registerfile1.write_data riscv8bit_tb.uut.id_to_wb1.id_and_ex1.id1.registerfile1.read_data_1 riscv8bit_tb.uut.id_to_wb1.id_and_ex1.id1.registerfile1.read_data_2 riscv8bit_tb.uut.id_to_wb1.id_and_ex1.id1.registerfile1.rst }
...
set _session_group_28 ifid1
gui_sg_create "$_session_group_28"
set ifid1 "$_session_group_28"

gui_sg_addsignal -group "$_session_group_28" { riscv8bit_tb.uut.id_to_wb1.id_and_ex1.id1.ifid1.instruction_ifid_output riscv8bit_tb.uut.id_to_wb1.id_and_ex1.id1.idex1.instruction_idex_output riscv8bit_tb.uut.id_to_wb1.id_and_ex1.exmem1.rd_exmem_output riscv8bit_tb.uut.id_to_wb1.memwb1.rd_memwb_output riscv8bit_tb.uut.id_to_wb1.id_and_ex1.id1.ifid1.clk riscv8bit_tb.uut.id_to_wb1.id_and_ex1.id1.ifid1.rst }

set _session_group_29 pc1
gui_sg_create "$_session_group_29"
set pc1 "$_session_group_29"

gui_sg_addsignal -group "$_session_group_29" { riscv8bit_tb.uut.pc1.clk riscv8bit_tb.uut.pc1.pc_increment_address riscv8bit_tb.uut.pc1.rst }
...
set _session_group_30 instruction_memory1
gui_sg_create "$_session_group_30"
set instruction_memory1 "$_session_group_30"

gui_sg_addsignal -group "$_session_group_30" { riscv8bit_tb.instruction_memory1.i riscv8bit_tb.instruction_memory1.rom_memory riscv8bit_tb.instruction_memory1.instruction riscv8bit_tb.instruction_memory1.instruction_address_from_pc riscv8bit_tb.instruction_memory1.rst }
gui_set_radix -radix enum -signals {Sim:riscv8bit_tb.instruction_memory1.rom_memory}
gui_set_radix -radix {decimal} -signals {Sim:riscv8bit_tb.instruction_memory1.instruction}
gui_set_radix -radix {unsigned} -signals {Sim:riscv8bit_tb.instruction_memory1.instruction}
gui_set_radix -radix {decimal} -signals {Sim:riscv8bit_tb.instruction_memory1.instruction_address_from_pc}
gui_set_radix -radix {unsigned} -signals {Sim:riscv8bit_tb.instruction_memory1.instruction_address_from_pc}
