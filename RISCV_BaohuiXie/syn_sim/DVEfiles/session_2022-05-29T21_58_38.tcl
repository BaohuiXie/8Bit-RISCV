...
# DVE full session
# Saved on Sun May 29 21:58:38 2022
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{8 31} {1713 953}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 155} {height 392} {dock_state left} {dock_on_new_line true} {child_hier_colhier 306} {child_hier_coltype 10} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 212} {height 392} {dock_state left} {dock_on_new_line true} {child_data_colvariable 140} {child_data_colvalue 100} {child_data_coltype 40} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1705} {height 431} {dock_state bottom} {dock_on_new_line true}}
...
set _session_group_4 data_memory1
gui_sg_create "$_session_group_4"
set data_memory1 "$_session_group_4"

gui_sg_addsignal -group "$_session_group_4" { riscv8bit_tb.data_memory1.memread riscv8bit_tb.data_memory1.i riscv8bit_tb.data_memory1.read_ram_data riscv8bit_tb.data_memory1.memwrite riscv8bit_tb.data_memory1.address_ram riscv8bit_tb.data_memory1.ram_memory riscv8bit_tb.data_memory1.write_data riscv8bit_tb.data_memory1.rst }
