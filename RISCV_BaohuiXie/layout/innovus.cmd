...
#  Created on Sun May 29 22:53:47 2022                
#                                                     
#######################################################
...
group_path -name in2reg_tmp.17542 -from {0x96 0x99} -to 0x9a -ignore_source_of_trigger_arc
getOptMode -allowPreCTSClkSrcPaths -quiet
set_global _is_ipo_interactive_path_groups 1
group_path -name in2out_tmp.17542 -from {0x9d 0xa0} -to 0xa1 -ignore_source_of_trigger_arc
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2reg_tmp.17542 -from 0xa3 -to 0xa4
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2out_tmp.17542 -from 0xa7 -to 0xa8
setPathGroupOptions reg2reg_tmp.17542 -effortLevel high
reset_path_group -name reg2out_tmp.17542
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name in2reg_tmp.17542
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name in2out_tmp.17542
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name reg2reg_tmp.17542
set_global _is_ipo_interactive_path_groups 0
...
getOptMode -allowPreCTSClkSrcPaths -quiet
set_global _is_ipo_interactive_path_groups 1
group_path -name in2reg_tmp.17542 -from {0xb2 0xb5} -to 0xb6 -ignore_source_of_trigger_arc
getOptMode -allowPreCTSClkSrcPaths -quiet
set_global _is_ipo_interactive_path_groups 1
group_path -name in2out_tmp.17542 -from {0xb9 0xbc} -to 0xbd -ignore_source_of_trigger_arc
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2reg_tmp.17542 -from 0xbf -to 0xc0
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2out_tmp.17542 -from 0xc3 -to 0xc4
setPathGroupOptions reg2reg_tmp.17542 -effortLevel high
reset_path_group -name reg2out_tmp.17542
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name in2reg_tmp.17542
...
win
panPage 0 1
zoomBox -18.26350 9.75300 105.38850 70.38500
