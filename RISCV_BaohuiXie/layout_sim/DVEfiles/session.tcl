...
# DVE full session
# Saved on Sun May 29 23:46:53 2022
# Designs open: 1
#   Sim: /afs/ee.ust.hk/staff/ee/bxieaf/eesm5020/risc_baohui/layout_sim/simv
...
#<Session mode="Full" path="/afs/ee.ust.hk/staff/ee/bxieaf/eesm5020/risc_baohui/layout_sim/DVEfiles/session.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{8 31} {1712 952}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 284} {height 392} {dock_state left} {dock_on_new_line true} {child_hier_colhier 306} {child_hier_coltype 10} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 239} {height 392} {dock_state left} {dock_on_new_line true} {child_data_colvariable 193} {child_data_colvalue 100} {child_data_coltype 40} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
set Console.1 [gui_create_window -type Console -parent ${TopLevel.1} -dock_state bottom -dock_on_new_line true -dock_extent 431]
gui_set_window_pref_key -window ${Console.1} -key dock_width -value_type integer -value 1647
gui_set_window_pref_key -window ${Console.1} -key dock_height -value_type integer -value 431
gui_set_window_pref_key -window ${Console.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1704} {height 430} {dock_state bottom} {dock_on_new_line true}}
...
gui_set_env SIMSETUP::SIMEXE {/afs/ee.ust.hk/staff/ee/bxieaf/eesm5020/risc_baohui/layout_sim/simv}
gui_set_env SIMSETUP::ALLOW_POLL {0}
if { ![gui_is_db_opened -db {/afs/ee.ust.hk/staff/ee/bxieaf/eesm5020/risc_baohui/layout_sim/simv}] } {
gui_sim_run Ucli -exe simv -args {-ucligui } -dir /afs/ee.ust.hk/staff/ee/bxieaf/eesm5020/risc_baohui/layout_sim -nosource
}
}
...
gui_sg_addsignal -group "$_session_group_13" { riscv8bit_tb.uut.id_to_wb1.id_and_ex1.id1.registerfile1.read_data_1 riscv8bit_tb.uut.id_to_wb1.id_and_ex1.id1.registerfile1.read_data_2 riscv8bit_tb.uut.id_to_wb1.id_and_ex1.id1.registerfile1.rd riscv8bit_tb.uut.id_to_wb1.id_and_ex1.id1.registerfile1.rs riscv8bit_tb.uut.id_to_wb1.id_and_ex1.id1.registerfile1.write_address riscv8bit_tb.uut.id_to_wb1.id_and_ex1.id1.registerfile1.write_data riscv8bit_tb.uut.id_to_wb1.id_and_ex1.id1.registerfile1.regwrite riscv8bit_tb.uut.id_to_wb1.id_and_ex1.id1.registerfile1.rst riscv8bit_tb.uut.id_to_wb1.id_and_ex1.id1.registerfile1.clk_clone3 riscv8bit_tb.uut.id_to_wb1.id_and_ex1.id1.registerfile1.clk_clone2 riscv8bit_tb.uut.id_to_wb1.id_and_ex1.id1.registerfile1.clk_clone1 riscv8bit_tb.uut.id_to_wb1.id_and_ex1.id1.registerfile1.clk riscv8bit_tb.uut.id_to_wb1.id_and_ex1.id1.registerfile1.register_memory }

set _session_group_14 data_memory1
gui_sg_create "$_session_group_14"
set data_memory1 "$_session_group_14"

gui_sg_addsignal -group "$_session_group_14" { riscv8bit_tb.data_memory1.ram_memory riscv8bit_tb.data_memory1.write_data riscv8bit_tb.data_memory1.memread riscv8bit_tb.data_memory1.i riscv8bit_tb.data_memory1.read_ram_data riscv8bit_tb.data_memory1.memwrite riscv8bit_tb.data_memory1.address_ram riscv8bit_tb.data_memory1.rst }
gui_set_radix -radix enum -signals {Sim:riscv8bit_tb.data_memory1.ram_memory}
...
catch {gui_list_select -id ${Hier.1} {riscv8bit_tb.data_memory1}}
...
gui_list_show_data -id ${Data.1} {riscv8bit_tb.data_memory1}
...
gui_open_source -id ${Source.1}  -replace -active riscv8bit_tb.input_stimulus /afs/ee.ust.hk/staff/ee/bxieaf/eesm5020/risc_baohui/layout_sim/../tb/riscv8bit_tb.v
